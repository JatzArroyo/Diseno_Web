...
4. ¿Qué extensión debe tener un archivo que contiene el código HTML de una página web? (valor 1.0)
...
6. ¿Menciona al menos 6 elementos semánticos en html5 y descríbelos brevemente? (valor 1.5)
